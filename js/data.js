const MASTER_DATA = {
    ...
    FRAGMENT_EFFECTS: {
        ...
        dexterous: { name: "器用", desc: "威力+10%/CT-10%", calc: (s) => { s.power *= 1.1; s.coolTime *= 0.90 } },
    ...
    CRYSTALS: {
        ...
        echo: { name: "真・残像", desc: "攻撃対象をマーク。マークした対象を別の味方が攻撃時に100%追撃", crystalCalc: (s) => { s.markEcho = true; } },
